...
HEMdat <- read.csv("04_bigRRoutput/0523outs/BcAtGWAS.HEM.csv")
...
write.csv(HEMdat2, "04_bigRRoutput/0523outs/BcAtGWAS.HEM.PlotFormat.csv") 
write.csv(HEMthresh, "04_bigRRoutput/0523outs/BcAtGWAS.HEM.Thresh.csv")
#read in to 06_plots