...
HEMdat <- read.csv("AthalianaLesion.0523.HEM.csv")
...
write.csv(HEMdat3, "At_phenos.HEM.PlotFormat.csv") 
write.csv(HEMthresh, "At_phenos.HEM.Thresh.csv")
#read in to RunningBigRRwithRF_02.R