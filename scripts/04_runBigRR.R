...
#---------------------------------------------------------------
rm(list=ls())
setwd("~/Documents/GitRepos/BcEudicotGWAS/data/GWAS_files/")
...
Phenos <- read.csv("03_bigRRinput/Pheno_bigRR_MAF20.csv", row.names = 1)
...
write.csv(rbind(thresh.HEM$"0.95Thresh",thresh.HEM$"0.975Thresh",thresh.HEM$"0.99Thresh",thresh.HEM$"0.999Thresh",outpt.HEM),"04_bigRRoutput/Sp_LesionSize_MAF20.HEM.csv")