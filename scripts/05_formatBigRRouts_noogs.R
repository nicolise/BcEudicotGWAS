...
HEMdat <- read.csv("At_noogs_MAF20.HEM_Full.csv")

#first remove first 4 rows (threshold data)
HEMthresh <- HEMdat[2:9,]
HEMdat <- HEMdat[-c(1:9),]
HEMdat2 <- HEMdat
...
write.csv(HEMdat2, "At_LesionSizenoogs_MAF20.HEM.PlotFormat.csv") 
write.csv(HEMthresh, "At_LesionSizenoogs_MAF20.HEM.Thresh.csv")
