...
HEMdat <- read.csv("04_bigRRoutput/Gm_Les.Pheno_HEM.csv")
...
write.csv(HEMdat2, "04_bigRRoutput/Gm_Les.Pheno_HEM.PlotFormat.csv") 
write.csv(HEMthresh, "04_bigRRoutput/Gm_Les.Pheno_HEM.Thresh.csv")
#read in to 06_plots