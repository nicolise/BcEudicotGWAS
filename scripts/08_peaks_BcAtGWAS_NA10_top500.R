...
HEM.plotdata <- read.csv("04_bigRRoutput/At_LesionSizes_MAF20_NA10.HEM.PlotFormat.csv")
names(HEM.plotdata)
...
HEM.thresh <- read.csv("04_bigRRoutput/At_LesionSize_MAF20_NA10.HEM.Thresh.csv")
...
HEM.topSNPs$Chrom <- gsub("Chromosome", "", HEM.topSNPs$Chrom)
HEM.topSNPs$Chrom <- as.numeric(as.character(HEM.topSNPs$Chrom))
HEM.topSNPs$Pos <- as.numeric(as.character(HEM.topSNPs$Pos))
write.csv(HEM.topSNPs, "05_processing/Top1000SNPs_BcAtGWAS_NA10.csv")
